...
const headRows = [
  ...
  { id: 'paymentMethodType', numeric: false, disablePadding: false, label: 'paymentMethod' },
  { id: 'userID.firstName', numeric: false, disablePadding: false, label: 'user' },
...
function EnhancedTableHead(props) {
  ...
  return (
    <TableHead>
      <TableRow>
        {headRows.map(row => (
          ['pickUpLocationID.name','status', 'paymentMethodType'].includes(row.id) && width < 769 ? null : 
          <TableCell
            key={row.id}
...
export default function EnhancedTable() {
  ...
  try {
      const result = await axios(`${PWA_API}/api/reservations?populate=["carID", "carModelID", "userID", "pickUpLocationID"]`, {
        headers: {
                  ...
                  return (
                    ...
                    >
                     ...
                     {width > 768 ?  <TableCell component="th" id={row._id} scope="row" padding="default" size="small">
                      ...
                      {width > 768 ?  <TableCell align="center">{row.paymentMethodType}</TableCell> : null}
